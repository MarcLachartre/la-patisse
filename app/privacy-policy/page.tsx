const PrivacyPolicy = () => {
    return (
        <div className="pageContainer">
            <h2>Privacy Policy for La Pâtisse</h2>

            <p>
                At La Pâtisse, accessible from
                https://la-patisse.herokuapp.com/, one of our main priorities is
                the privacy of our visitors. This Privacy Policy document
                contains types of information that is collected and recorded by
                La Pâtisse and how we use it.
            </p>
            ...
            <p>
                La Pâtisse legal basis for collecting and using the personal
            ...
            <ul>
                <li>La Pâtisse needs to perform a contract with you</li>
                <li>You have given La Pâtisse permission to do so</li>
                <li>
                    Processing your personal information is in La Pâtisse
                    legitimate interests
                </li>
                <li>La Pâtisse needs to comply with the law</li>
            </ul>

            <p>
                La Pâtisse will retain your personal information only for as
            ...
            <p>
                La Pâtisse follows a standard procedure of using log files.
            ...
            <p>
                Like any other website, La Pâtisse uses "cookies". These cookies
            ...
            <p>
                ...
                the advertising partners of La Pâtisse.
            </p>

            <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on La Pâtisse,
            ...
            <p>
                Note that La Pâtisse has no access to or control over these
            ...
            <p>
                La Pâtisse's Privacy Policy does not apply to other advertisers
            ...
            <p>
                La Pâtisse does not knowingly collect any Personal Identifiable
            ...
            <p>
                ...
                information that they shared and/or collect in La Pâtisse. This
